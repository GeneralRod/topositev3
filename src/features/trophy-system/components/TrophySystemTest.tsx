    ...
    <div className="trophy-system-test">
      ...
      <div className="test-controls">
        ...
        <div className="button-group">
          <button onClick={simulateCorrectAnswer}>Simulate Correct Answer (+10-60 points)</button>
          <button onClick={simulatePerfectScore}>Simulate Perfect Score (Europe)</button>
          <button onClick={simulateSpeedRun}>Simulate Speed Run (25s)</button>
          <button onClick={simulateStreak}>Simulate 7-Day Streak</button>
        </div>
